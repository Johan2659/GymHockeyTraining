    ...
    group('AES Key Security Verification', () {
      test('should generate and manage AES keys securely', () async {
        ...
        expect(key.length, equals(32),
            reason: 'AES key should be 32 bytes (256 bits)');
    ...
    group('Crash Handling & Graceful Degradation', () {
      test('should handle storage failures gracefully', () async {
        ...
        expect(newKey, isNot(equals(originalKey)),
            reason: 'Should generate a new key');

        debugPrint(
            '✅ Crash handling test PASSED - App handles storage failures gracefully');
      });
      ...
      test('should recover from key corruption gracefully', () async {
        ...
        debugPrint(
            '✅ Recovery test PASSED - App handles storage corruption gracefully');
      });
    });
  });
}
