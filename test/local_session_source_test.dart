  ...
  group('LocalSessionSource Tests', () {
    ...
    group('getSessionsByProgramId', () {
      test('should load all attacker sessions', () async {
        final sessions =
            await source.getSessionsByProgramId('hockey_attacker_2025');
      ...
      test('should load all defender sessions', () async {
        final sessions =
            await source.getSessionsByProgramId('hockey_defender_2025');
        expect(sessions, isNotEmpty);
      ...
      test('should load all goalie sessions', () async {
        final sessions =
            await source.getSessionsByProgramId('hockey_goalie_2025');
        expect(sessions, isNotEmpty);
      ...
      test('should load all referee sessions', () async {
        final sessions =
            await source.getSessionsByProgramId('hockey_referee_2025');
        expect(sessions, isNotEmpty);
      ...
      test('should return empty list for invalid program', () async {
        final sessions =
            await source.getSessionsByProgramId('invalid_program_id');
    ...
    group('getSessionsByWeek', () {
      test('should load attacker sessions by week', () async {
        final sessions =
            await source.getSessionsByWeek('hockey_attacker_2025', 0); // Week 1
        expect(sessions, isNotEmpty);
      ...
      test('should load defender sessions by week', () async {
        final sessions =
            await source.getSessionsByWeek('hockey_defender_2025', 0); // Week 1
        expect(sessions, isNotEmpty);
      ...
      test('should load goalie sessions by week', () async {
        final sessions =
            await source.getSessionsByWeek('hockey_goalie_2025', 0); // Week 1
        expect(sessions, isNotEmpty);
      ...
      test('should load referee sessions by week', () async {
        final sessions =
            await source.getSessionsByWeek('hockey_referee_2025', 0); // Week 1
        expect(sessions, isNotEmpty);
      ...
      test('should return empty list for invalid week', () async {
        final sessions =
            await source.getSessionsByWeek('hockey_attacker_2025', 99);
        expect(sessions, isEmpty);
      });

      test('should return empty list for invalid program', () async {
        final sessions =
            await source.getSessionsByWeek('invalid_program_id', 0);
        expect(sessions, isEmpty);
      });
    });
  });
