...
void main() {
  group('Step 5 — SSOT AppState Tests', () {
    ...
    test('Mutations append events and update state', () async {
      ...
      expect(appState.events.any((e) => e.type == ProgressEventType.sessionStarted), isTrue);
      expect(appState.events.any((e) => e.type == ProgressEventType.exerciseDone), isTrue);
    ...
    test('streak calculated correctly with test events', () async {
      ...
      expect(appState.currentStreak, lessThanOrEqualTo(365)); // Reasonable upper bound
    });
    ...
    test('All derived values work together', () async {
      ...
      expect(appState.events.length, greaterThanOrEqualTo(4)); // start + 2 exercises + bonus
    });
  });
}
